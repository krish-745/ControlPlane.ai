  ...
  head: () => ({
    meta: [
      ...
      { title: "ControlPlane — Real-time AI Oversight" },
      {
        name: "description",
        content:
          "ControlPlane inspects every AI response for grounding, cost and safety before it reaches your users.",
      },
      { property: "og:title", content: "ControlPlane — Real-time AI Oversight" },
      {
